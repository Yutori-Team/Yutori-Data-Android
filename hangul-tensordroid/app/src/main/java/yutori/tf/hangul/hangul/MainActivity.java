...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private yutori.tf.hangul.hangul.PaintView paintView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paintView = (yutori.tf.hangul.hangul.PaintView) findViewById(R.id.paintView);
            ...
            public void run() {
                try {
                    classifier = HangulClassifier.create(getAssets(),
                            MODEL_FILE, LABEL_FILE, yutori.tf.hangul.hangul.PaintView.FEED_DIMENSION,
